/**
 * @generated SignedSource<<59489009517f3a78df943ea62cdfba66>>
...
export type mutationsCreateTripMutation$variables = {
  input: ReadonlyArray<tripsInsertInput>;
};
export type mutationsCreateTripMutation$data = {
...
export type mutationsCreateTripMutation = {
  response: mutationsCreateTripMutation$data;
  variables: mutationsCreateTripMutation$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "mutationsCreateTripMutation",
    "selections": (v1/*: any*/),
    "type": "Mutation",
    "abstractKey": null
  },
  ...
  "params": {
    "cacheID": "0cc6b9b941a4a6bba89709a1c03c3045",
    "id": null,
    "metadata": {},
    "name": "mutationsCreateTripMutation",
    "operationKind": "mutation",
    "text": "mutation mutationsCreateTripMutation(\n  $input: [tripsInsertInput!]!\n) {\n  insertIntotripsCollection(objects: $input) {\n    affectedCount\n    records {\n      id\n      name\n      description\n      is_published\n      created_at\n      start_date\n      trips_summary_geometry_geojson\n      bounds_min_lat\n      bounds_min_lng\n      bounds_max_lat\n      bounds_max_lng\n    }\n  }\n}\n"
  }
};
})();

(node as any).hash = "b294827466842245138373bf2902b4c8";
